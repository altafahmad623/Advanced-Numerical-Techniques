...
int main()
{
    ...
    while (diff > error)
    {
        ...
        if (iter >= 10) // pseudo code for checking . remove this later
        {
            break;
        }
    }
