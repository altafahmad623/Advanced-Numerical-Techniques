...
// \frac{ \partial T}{\partial t} + u \frac{ \partial T}{\partial x} = \alpha \frac{ \partial^2 T}{\partial x^2} \; , 0 < x < 1;
// u = 0.1 , \alpha = 0.01 , T(0,t) = 0 , T(1,t) = 100, T(x, 0) = 100 \times x 
...
int main()
{
    ...
    {
        col[0] = 0;
        col[N] = 100; // these are the initial conditions that nee
        for (int i = 1; i < N; i++)
        {
